 ...
 * @author tugba
 */
public class ChangeColor_RadioButton extends javax.swing.JFrame {

    /**
     * Creates new form ChangeColor_RadioButton
     */
    public ChangeColor_RadioButton() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeColor_RadioButton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeColor_RadioButton().setVisible(true);
            }
        });
    }
